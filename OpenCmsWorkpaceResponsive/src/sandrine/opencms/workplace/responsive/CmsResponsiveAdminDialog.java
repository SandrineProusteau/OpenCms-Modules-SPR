...
/**
 * Workplace class for /system/workplace/views/admin/admin-main-responsive.jsp .<p>
 * 
 * @since 6.0.0 
 */
public class CmsResponsiveAdminDialog extends CmsDialog {
     ...
     */
    public CmsResponsiveAdminDialog(CmsJspActionElement jsp) {
     ...
     */
    public CmsResponsiveAdminDialog(PageContext context, HttpServletRequest req, HttpServletResponse res) {
