...
public class CmsResponsiveLogin extends CmsJspLoginBean {
    ...
    private static final String JSP_WORKPLACE_URI = CmsWorkplace.VFS_PATH_VIEWS + "workplace-responsive.jsp";

    /** The log object for this class. */
    private static final Log LOG = CmsLog.getLog(CmsResponsiveLogin.class);
     ...
     */
    public CmsResponsiveLogin(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    public String displayDialog() throws IOException {
        ...
        if (m_requestedResource == null) {
        	...
        	m_requestedResource = this.JSP_WORKPLACE_URI;
        }
        ...
        if (m_action == ACTION_LOGIN) {
            ...
            if (CmsStringUtil.isEmptyOrWhitespaceOnly(resource)) {
            	...
            	resource = this.JSP_WORKPLACE_URI;
            }
            if (!getCmsObject().existsResource(resource, CmsResourceFilter.ONLY_VISIBLE_NO_DELETED)) {
            	...
            	if (this.JSP_WORKPLACE_URI.equals(resource)) {
            	...
            	} else if (getCmsObject().existsResource(this.JSP_WORKPLACE_URI)) {
    ...
    protected String displayLoginForm() {
        ...
        html.append(this.link("/system/modules/sandrine.opencms.workplace.responsive/css/workplace.css"));
        html.append("\">\n");
        ...
        html.append("<div id=\"login-center\">\n");
        ...
        if (m_action == ACTION_DISPLAY) {
            // start form
            html.append("<form class=\"login-form\" action=\"");
            html.append(getFormLink());
            html.append("\"");
        ...
        if ((m_action == ACTION_DISPLAY) && OpenCms.getLoginManager().isEnableSecurity()) {
            ...
            html.append("<div class=\"security\">");
        ...
        html.append("<td class=\"picto\" rowspan=\"5\">");
        html.append("<img src=\"");
        ...
        if (m_action == ACTION_DISPLAY) {
            ...
            html.append("<tr>\n");
            html.append("<td class=\"label\"><div id='ouLabelId' style='display: none;'><b>");
            html.append(Messages.get().getBundle(m_locale).key(Messages.GUI_LOGIN_ORGUNIT_0)).append(
                "</b>&nbsp;&nbsp;\n");
            html.append("</div></td>\n");
            html.append("<td class=\"field\"><div id='ouSearchId' style='display: none;'><input class=\"inactive\" type=\"text\" value=\"");
            html.append(Messages.get().getBundle(m_locale).key(Messages.GUI_LOGIN_ORGUNIT_SEARCH_0));
            html.append("\"");
            ...
            html.append("<tr>\n");
            html.append("<td class=\"field-select-ou\" colspan=\"2\"><div id='ouSelId' style='display: none;'>");
            html.append("</div></td>\n");
            html.append("</tr>\n");
        ...
        html.append("<div class=\"free-software\">");
    ...
    protected String getPreDefOuFqn() {
        ...
        if (Boolean.valueOf(m_actionLogout).booleanValue() && (getRequest().getAttribute(PARAM_PREDEF_OUFQN) == null)) {
            ...
            getRequest().setAttribute(CmsResponsiveLogin.PARAM_PREDEF_OUFQN, oufqn);
        }
