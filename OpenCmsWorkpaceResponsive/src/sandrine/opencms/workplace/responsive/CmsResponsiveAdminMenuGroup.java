 ...
 * @since 6.0.0 
 */
public class CmsResponsiveAdminMenuGroup {

    /** Item container. */
    private final CmsIdentifiableObjectContainer<CmsResponsiveAdminMenuItem> m_container = new CmsIdentifiableObjectContainer<CmsResponsiveAdminMenuItem>(
        true,
        true);
     ...
     */
    public CmsResponsiveAdminMenuGroup(String id, String name) {
     ...
     */
    public void addMenuItem(CmsResponsiveAdminMenuItem item) {
     ...
     */
    public void addMenuItem(CmsResponsiveAdminMenuItem item, float position) {
     ...
     * 
     * @return a list of <code>{@link CmsResponsiveAdminMenuItem}</code>s
     */
    public List<CmsResponsiveAdminMenuItem> getMenuItems() {
    ...
    public String groupHtml(CmsWorkplace wp) {
        ...
        Iterator<CmsResponsiveAdminMenuItem> itItem = m_container.elementList().iterator();
        while (itItem.hasNext()) {
            CmsResponsiveAdminMenuItem item = itItem.next();
    ...
    /*private String htmlStart(CmsWorkplace wp) {
        ...
        html.append("<div class='navOpened navBlock' id='");
        html.append(getId());
        html.append("'>\n");
        html.append("\t\t<div class='titleBorder'>\n");
        html.append("\t\t\t<div class='navTitle' onMouseOver='mouseGroupEvent(this, true);' onMouseOut='mouseGroupEvent(this, false);' onClick=\"return openGroup('");
        html.append(getId());
        html.append("');\" >\n");
        ...
        html.append("\t\t\t</div>\n");
        html.append("\t\t</div>\n");
        html.append("\t\t<div class='treeBorder'>\n");
    ...
    private String htmlStart(CmsWorkplace wp) {
    	...
    	StringBuffer html = new StringBuffer(1024);
    	if(!getId().equals("help")){
    		html.append("<div class='navBlock'>");
    	}else{
    		html.append("<div class='navBlockHelp'>");
    	}
        ...
        html.append("\t\t\t<table border='0' cellspacing='0' cellpadding='0' width='100%' class='navTitle' onMouseOver='mouseGroupEvent(this, true);' onMouseOut='mouseGroupEvent(this, false);' onClick=\"openGroup('");
        html.append(getId());
        html.append("');IframeStructInitRefresh();\" >\n");
        html.append("\t\t\t\t<tr>\n");
