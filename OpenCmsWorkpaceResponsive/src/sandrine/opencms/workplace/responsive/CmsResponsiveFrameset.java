 ...
 * <ul>
 * <li>/views/top.html
 * <li>/views/top_foot-responsive.html
 * <li>/views/top_head-responsive.html
 * </ul>
 * <p> 
 * 
 * @since 6.0.0 
 */
public class CmsResponsiveFrameset extends CmsWorkplace {
    ...
    public static final String JSP_WORKPLACE_URI = CmsWorkplace.VFS_PATH_VIEWS + "workplace-responsive.jsp";
    ...
    private static final Log LOG = CmsLog.getLog(CmsResponsiveFrameset.class);
     ...
     */
    public CmsResponsiveFrameset(CmsJspActionElement jsp) {
    ...
    public String getPreferencesButton() {
        ...
        if (!getCms().getRequestContext().getCurrentUser().isManaged()) {
            ...
            return buttonResponsive(null, null, "preferences_in.png", Messages.GUI_BUTTON_PREFERENCES_0, buttonStyle);
        }
    }
    ...
    public String getPublishButton() {
        ...
        if (getCms().isManagerOfProject()) {
            ...
            return (buttonResponsive(null, null, "publish_in.png", Messages.GUI_BUTTON_PUBLISH_0, buttonStyle));
        }
    }
    ...
    public String getPublishQueueButton() {
        ...
        js.append("';");
        js.append("};");
        return buttonResponsive(js.toString(), null, "publish_queue.png", Messages.GUI_BUTTON_PUBLISHQUEUE_0, buttonStyle);
    }
    ...
    public String getStartupUri() {
        ...
        return CmsRequestUtil.appendParameter(result, CmsResponsiveFrameset.PARAM_WP_FRAME, FRAMES[2]);
    }
    ...
    public String getWorkplaceReloadUri() {
        ...
        return getJsp().link(CmsResponsiveFrameset.JSP_WORKPLACE_URI);
    }
    ...
    protected void initWorkplaceRequestValues(CmsWorkplaceSettings settings, HttpServletRequest request) {
        ...
        String frame = CmsRequestUtil.getNotEmptyDecodedParameter(request, CmsResponsiveFrameset.PARAM_WP_FRAME);
        ...
        // check if a startup page has been set
        String startup = CmsRequestUtil.getNotEmptyDecodedParameter(request, CmsResponsiveFrameset.PARAM_WP_START);
        if (startup != null) {
        ...
        String view = request.getParameter(CmsResponsiveFrameset.PARAM_WP_VIEW);
        if (view != null) {
            m_reloadRequired = true;
     ...
     */
    public String buttonResponsive(String href, String target, String image, String label, int type) {

        return buttonResponsive(href, target, image, label, type, getSkinUri() + "buttons/");
    }
     ...
     * @return a button for the OpenCms workplace
     */
    public String buttonResponsive(String href, String target, String image, String label, int type, String imagePath) {
